...
import { getUsers, getUsersAdmin, getUsersDriver, getUserById, createUser, updateUser, deleteUser, updateFCMToken, getVisibleDrivers, checkUserExists } from "./controller/UserController.js";
...
import { getRouteByCodeRoute, getRoutesByDriverId, getHistoryRoutesByDriverId, createRoute, updateRouteStatus, updateActualArrivalTime, getRouteById, updateRoute, reportRouteDeviation, getPendingDeviations, markDeviationAsSeen, getUnseenDeviations, sendRouteNotification } from "./controller/RouteController.js";
...
app.get("/user/check/:id", checkUserExists);
app.get("/user/:id", getUserById);
app.post("/users", createUser);
app.put("/user/:id", updateUser);
app.delete("/user/:id", deleteUser);
app.post("/user/fcm-token", updateFCMToken);
app.get("/users/visible-drivers", getVisibleDrivers);
...
app.patch('/route/arrival/:codeRoute', updateActualArrivalTime);
